...
export default function CartPage() {
    ...
    // ESTADO FIJO: Por ahora forzamos 'pickup' (Retiro Local)
    const [shippingMethod, setShippingMethod] = useState('pickup'); 
    
    // Estados de envío (mantenidos para futura reactivación)
    ...
    // Cálculos de totales (El costo de envío ahora siempre es 0)
    ...
    // Función de cotización comentada temporalmente
    /*
    const handleQuoteShipping = async () => {
        // ... (código original de cotización mantenido pero inactivo) ...
    };
    */
    ...
    const handleCheckout = async (e) => {
        ...
        // Validación omitida por ahora ya que solo hay pickup
        /*
        ...
        */
        ...
        try {
            ...
            const fixedAddress = 'RETIRO EN LOCAL: CÓDIGO VINARIO (Av. Colón 701, Mendoza Capital)';
            const finalAddress = fixedAddress; // Forzado a pickup
            const finalShippingMethod = 'pickup';
            ...
            <div className="cart-container-pro">
                ...
                <aside className="cart-checkout-sidebar">
                    <form className="checkout-form-premium" onSubmit={handleCheckout}>
                        ...
                        {/* SECCIÓN DE ENVÍO OCULTA TEMPORALMENTE */}
                        ...
                        */}
                        ...
                        <div className="form-inputs-group">
                            ...
                            <div className="pickup-info-card animate-fade" style={{ marginTop: '5px', marginBottom: '15px' }}>
                                ...
                                <div className="map-container" style={{ width: '100%', marginTop: '15px', borderRadius: '12px', overflow: 'hidden' }}>
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3350.25875225126!2d-68.8502396!3d-32.8913296!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x967e090333d4540d%3A0xc0fb19cecc6236b3!2sAv.%20Col%C3%B3n%20701%2C%20M5500%20Mendoza!5e0!3m2!1ses-419!2sar!4v1717462000000!5m2!1ses-419!2sar"
                                        width="100%"
                                        height="250"
                                        style={{ border: 0 }}
                                        allowFullScreen=""
                        ...
                        <div className="total-summary-card">
                            ...
                            {/* TEXTO DE ENVÍO A CALCULAR OCULTO TEMPORALMENTE */}
