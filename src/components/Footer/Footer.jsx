...
export default function Footer() {
  return (
    <footer className="footer-geometric">
      ...
      {/* 🔥 CORDILLERA ENTRELAZADA (Profundidad exacta según tu boceto) */}
      <div className="footer-geometric__landscape">
        <svg className="andes-sharp" viewBox="0 0 1440 200" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* CAPA 1 (Fondo lejano): Montañas chiquitas que nacen de las medianas */}
          <path d="M0,200 L0,180 L320,80 L600,200 L840,200 L1120,80 L1440,180 L1440,200 Z" fill="#342c27" />
          
          {/* CAPA 2 (Medio): Montañas medianas que nacen casi de la punta de la montaña grande */}
          <path d="M0,200 L240,200 L520,40 L720,180 L920,40 L1200,200 L1440,200 Z" fill="#231e1a" />
          
          {/* CAPA 3 (Frente): Montaña ALFA central */}
      ...
      {/* REDES SOCIALES (Íconos oficiales y limpios) */}
      <div className="footer-geometric__socials">
        
        {/* INSTAGRAM (Mismo que aprobaste) */}
        ...
        {/* CANAL DE DIFUSIÓN (Megáfono claro y delineado) */}
        ...
        {/* TIKTOK OFICIAL (Logo exacto con viewBox adaptado para que no se corte jamás) */}
