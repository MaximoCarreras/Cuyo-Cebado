  ...
  return (
    <footer className="footer-geometric">
      ...
      <div className="footer-geometric__socials">
        ...
        <a href="https://www.instagram.com/TU_USUARIO" target="_blank" rel="noreferrer" title="Instagram" className="icon-social-sharp">
        ...
        <a href="https://wa.me/549261TU_NUMERO" target="_blank" rel="noreferrer" title="WhatsApp" className="icon-social-sharp">
          <svg viewBox="0 0 24 24" fill="currentColor" width="26" height="26">
        ...
        <a href="https://whatsapp.com/channel/TU_LINK_DEL_CANAL" target="_blank" rel="noreferrer" title="Canal de Difusión" className="icon-social-sharp">
