 ...
 * Se reemplazó el carrito por contacto directo por WhatsApp con logo oficial.
 */
import kitImage from '../../assets/kit_regalo.png';
import './GiftKit.css';

export default function GiftKit() {
  const WHATSAPP_URL = "https://wa.me/5492625597956?text=Hola!%20Me%20interesa%20el%20Kit%20Regalo%20Premium%20que%20vi%20en%20la%20web";
    ...
    <section className="giftkit section" id="kit-regalo">
      <div className="giftkit__container section__container">
        ...
        <div className="giftkit__content">
          ...
          {/* Botón con Logo de WhatsApp Oficial */}
          <a
            href={WHATSAPP_URL}
            target="_blank"
